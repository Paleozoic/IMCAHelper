...
public class VirtualKeyBoard {
	public static  WinIo winIo = null;
	static {
		NativeLibrary.addSearchPath("WinIo32", VirtualKeyBoard.class.getResource("/WinIo").getPath());
		NativeLibrary.addSearchPath("WinIo64", VirtualKeyBoard.class.getResource("/WinIo").getPath());
		winIo = WinIo.INSTANCE;
